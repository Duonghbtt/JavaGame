...
public class GetOutPanel extends GamePanel {
    ...
    public GetOutPanel(JFrame frame) {
    ...
    public void setPieces() {
        ...
        pieces.add(new Knight(WHITE, 4, 6));
        pieces.add(new Pawn(WHITE, 6, 6));
        pieces.add(new Queen(WHITE, 5, 7));
        pieces.add(new Queen(BLACK, 7, 4));
        pieces.add(new King(WHITE, 7, 7));
        pieces.add(new King(BLACK, 2, 0));
    }
