...
public class RookPanel extends GamePanel {
    ...
    public RookPanel(JFrame frame) {
        ...
        messageArea = new JTextArea(" Quân xe\n Quân Xe di chuyển bất kỳ số ô trống nào theo chiều quân ngang hoặc chiều dọc."
                + " Nó không thể nhảy qua các quân khác.");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                messageArea.setText("Hãy thử di chuyển quân Xe đến bất kỳ ô hợp lệ nào.");
                if (click == 1) {
