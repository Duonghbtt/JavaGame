...
public class KingPanel extends GamePanel {
    ...
    public KingPanel(JFrame frame) {
        ...
        messageArea = new JTextArea(" Quân Vua\n Quân Vua di chuyển một ô trống theo bất kỳ hướng nào, trừ khi nước đó khiến Vua bị chiếu. Vua không thể nhảy qua các quân cờ khác. ");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                messageArea.setText("Hãy thử di chuyển quân Vua đến bất kỳ ô hợp lệ nào.");
                if (click == 1) {
