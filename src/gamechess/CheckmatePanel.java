...
public class CheckmatePanel extends GamePanel {
    ...
    public CheckmatePanel(JFrame frame) {
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("Next button clicked");
                    ...
                    messageArea.setText(" Chiếu tướng\n Vua Đen đang ẩn núp an toàn phía sau quân Tốt. Hãy chiếu hết trong khi cũng bắt quân Mã đối phương bằng cách di chuyển quân Hậu từ d6 đến f8.");
    ...
    public void setPieces() {
        ...
        pieces.add(new Rook(WHITE, 3, 7));
        pieces.add(new Queen(WHITE, 3, 2));
