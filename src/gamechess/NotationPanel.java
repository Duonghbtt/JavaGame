...
public class NotationPanel extends GamePanel {
    ...
    public NotationPanel(JFrame frame) {
        ...
        messageArea = new JTextArea(" Ký hiệu\n Mỗi ô vuông trong cờ vua được xác định duy nhất bằng một tập hợp tọa độ, a-h cho hàng dọc (ngang) theo sau là 1-8 cho hàng ngang dọc.");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("Next button clicked");
                    messageArea.setText(" Ký hiệu\n Quân hậu của bạn hiện đang ở e3, hãy di chuyển đến c5. Cố gắng tìm c5 bằng cách sử dụng các chữ cái trên đường viền. ");
