...
public class QueenPanel extends GamePanel {
    ...
    public QueenPanel(JFrame frame) {
        ...
        messageArea = new JTextArea(" Quân Hậu\n Quân Hậu là quân mạnh nhất.Nó di chuyển bất kỳ số ô trống nào theo chiều ngang,chiều dọc hoặc đường chéo"
                + ", kết hợp các nước đi của Xe và Tượng. Nó không thể nhảy qua các quân khác. ");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                messageArea.setText("Hãy thử di chuyển quân Hậu đến bất kỳ ô hợp lệ nào.");
                if(click==1){
