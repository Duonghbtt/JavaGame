...
public class CapturingPanel extends GamePanel {
    ...
    public CapturingPanel(JFrame frame) {
        ...
        messageArea = new JTextArea(" Bắt quân\n Bắt quân của đối thủ là mục tiêu chính trong cờ vua. Khi một nước đi của bạn rơi vào ô mà quân của đối thủ đang đứng, quân đó sẽ bị bạn bắt. ");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (click == 1) {
                    messageArea.setText(" Bắt quân\n Một quân tốt chỉ có thể bắt quân của đối phương ở một trong hai ô vuông theo đường chéo ở phía trước nhưng không thể di chuyển đến những ô vuông đó nếu chúng trống.");
                }
                if (click == 2) {
                    isInteractionEnabled = true;
                    nextButton.setEnabled(false);
                    messageArea.setText(" Bắt quân\n Bây giờ hãy bắt quân Hậu của đối phương bằng quân Tốt của bạn.");
                }
            }
        });
    ...
    public void setPieces() {
        ...
        pieces.add(new Pawn(WHITE, 3, 5));
        pieces.add(new Queen(BLACK, 4, 4));
