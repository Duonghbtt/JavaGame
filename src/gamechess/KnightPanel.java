...
public class KnightPanel extends GamePanel {
    ...
    public KnightPanel(JFrame frame) {
        ...
        messageArea = new JTextArea("Quân mã\n Quân Mã di chuyển theo hình chữ L bất kỳ hướng nào, đầu tiên di chuyển hai ô theo "
                + "một hướng và sau đó di chuyển một ô sang ngang. Nó có thể nhảy sang các quân cờ khác. ");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                messageArea.setText("Hãy thử di chuyển quân Mã đến bất kỳ ô hợp lệ nào.");
                if(click==1){
