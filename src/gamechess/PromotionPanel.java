...
public class PromotionPanel extends GamePanel {
    ...
    public PromotionPanel(JFrame frame) {
        ...
        messageArea = new JTextArea(" Tiến chốt\n Khi một quân Tốt đến cuối bàn cờ, nó có thể được thay thế bằng bất kỳ quân nào, ngoại trừ Vua. Đây được gọi là phong cấp Tốt.");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (click == 1) {
                    ...
                    messageArea.setText(" Tiến chốt\n Hãy di chuyển quân Tốt đến cuối, sau đó bạn có thể chọn bất kỳ quân cờ nào bạn muốn thay thế cho quân Tốt.");
                }
            }
        });
