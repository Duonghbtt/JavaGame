...
public class PawPanel extends GamePanel {
    ...
    public PawPanel(JFrame frame) {
        ...
        messageArea = new JTextArea("Quân tốt\nMột quân tốt chỉ có thể di chuyển về phía trước "
                + "một ô nếu ô đó trống. Nếu nó chưa di chuyển, một quân tốt "
                + "cũng có thể di chuyển về phía trước hai ô nếu cả hai ô đều trống");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                messageArea.setText("Quân tốt\n Chạm vào ô quân Tốt, sau đó chạm vào bất kỳ ô màu xanh lá cây nào được chỉ "
                        + "định để di chuyển. Các nước đi hợp lệ được chỉ định bằng dấu màu xanh lá cây");
                if(click==1){
