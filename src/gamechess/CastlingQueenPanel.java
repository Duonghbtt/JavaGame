...
public class CastlingQueenPanel extends GamePanel {
    ...
    public CastlingQueenPanel(JFrame frame) {
        ...
        messageArea = new JTextArea(" Nhập thành - Phía hậu\n Nhập thành về phía phải thường được gọi là Kingside Castling");
        ...
        nextButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(click == 1){
                    ...
                    messageArea.setText(" Nhập thành - Phía hậu\n Bạn hãy thử nhập thành về phía bên trái.");
                }
            }
        });
